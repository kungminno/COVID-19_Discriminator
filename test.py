...
def mod(cough_segments, addr):
    ...
    for j in range(len(cough_segments)):
        data_seg_rec['id'].append(str(addr))
    ...
    return MERGM_f.predict(TEST),len(test_labels)
    ...
    try:
        ...
        while 1:
            ...
            if x=='a':
                ...
                wav = 'C:/Users/kungm/Desktop/test/cough/user_input_w/172.30.1.3354810.wav'
                cough_segments, cough_mask = cough_s(wav)

                y_preds_test, l = mod(cough_segments, 3354810)
